package com.cloud.ecomerce.mailer;
...
public class EmailServiceApplication {
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cloud.ecomerce.mailer.controller"))
                ...
                .apiInfo(new ApiInfoBuilder().version("1.0").title("Email API").description("Documentation Email API v1.0").build());
    }
