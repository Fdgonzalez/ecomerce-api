package com.cloud.ecomerce.orders;
...
public class OrdersService{
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cloud.ecomerce.orders.controller"))
                ...
                .apiInfo(new ApiInfoBuilder().version("1.0").title("Orders API").description("Documentation Order API v1.0").build());
    }
