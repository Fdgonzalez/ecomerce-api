package com.cloud.ecomerce.products;
...
@EnableFeignClients
@EnableSwagger2
public class ProductService extends WebSecurityConfigurerAdapter {
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.cloud.ecomerce.products.controller"))
